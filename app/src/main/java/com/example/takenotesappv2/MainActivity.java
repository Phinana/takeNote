...
import com.example.takenotesappv2.model.Note;
...
import com.example.takenotesappv2.model.Adapter;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setSupportActionBar programin cokmesine sebep oluyor. Bir ara cozmem lazim.
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            default:
                Toast.makeText(this, "Suanda Hazir Degil", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
